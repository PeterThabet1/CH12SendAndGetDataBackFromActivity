...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        input_weight.hint = "weight (Kg)"
        input_height.hint = "height (cm)"
        ...
        btn_send_data.setOnClickListener {
            ...
            input_weight.text.toString().toFloatOrNull()?.let {
                    it1 -> m_bundle.putFloat("weight", it1)
            }
            input_height.text.toString().toFloatOrNull()?.let {
                    it1 -> m_bundle.putFloat("height", it1)
            }
